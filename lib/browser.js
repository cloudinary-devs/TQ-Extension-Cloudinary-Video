...
// save the last URL entry if there was some entry in there.
savedUrl = "";
...
module.exports = new class Browser {
    ...
    constructor() {
        console.debug('constructing Browser');
    ...
    hide(clearContent = true) {
        this.content && this.content[0] && this.content[0].childNodes[3] && (savedUrl = this.content[0].childNodes[3].value);
        this.browser.hide();
