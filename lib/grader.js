...
module.exports = class Grader extends EventEmitter {
    ...
    actionDescriptions =
        {
            ...
            'c_fill': {
                title: 'fill',
                docsUrl: 'https://cloudinary.com/documentation/transformation_reference#c_fill'
            },
            'co_': {
                title: 'color',
                docsUrl: 'https://cloudinary.com/documentation/transformation_reference#co_color'
            },
            'dl_': {
                title: 'delay',
                docsUrl: 'https://cloudinary.com/documentation/transformation_reference#dl_delay'
            },
            'du_': {
                title: 'duration',
                docsUrl: 'https://cloudinary.com/documentation/transformation_reference#du_duration'
            },
            'w_': {
                title: 'width',
                docsUrl: 'https://cloudinary.com/documentation/transformation_reference#w_width'
            },
            'g_': {
                title: 'gravity',
                docsUrl: 'https://cloudinary.com/documentation/transformation_reference#g_gravity'
            },
            'eo_': {
                title: 'timing offset end',
                docsUrl: 'https://cloudinary.com/documentation/transformation_reference#eo_end_offset'
            },
            'so_': {
                title: 'timing offset start',
                docsUrl: 'https://cloudinary.com/documentation/transformation_reference#so_start_offset'
            },
            'r_': {
                title: 'rounding',
            ...
            'h_': {
                title: 'height',
                docsUrl: 'https://cloudinary.com/documentation/transformation_reference#h_height'
            },
            'l_': {
                title: 'layer',
                docsUrl: 'https://cloudinary.com/documentation/transformation_reference#l_layer'
            },
            'l_text': {
                title: 'text layer',
                docsUrl: 'https://cloudinary.com/documentation/transformation_reference#l_text'
            },
            'l_video': {
                title: 'video layer',
                docsUrl: 'https://cloudinary.com/documentation/transformation_reference#l_video'
            },
            'o_': {
                title: 'opacity',
                docsUrl: 'https://cloudinary.com/documentation/transformation_reference#o_opacity'
            },
            'q_': {
                title: 'quality',
                docsUrl: 'https://cloudinary.com/documentation/transformation_reference#q_quality'
            },
            'y_': {
                title: 'y location or offset',
                docsUrl: 'https://cloudinary.com/documentation/transformation_reference#x_y_coordinates'
            },
            'x_': {
                title: 'x location or offset',
                docsUrl: 'https://cloudinary.com/documentation/transformation_reference#x_y_coordinates'
            },
            'e_': {
                title: 'e',
            ...
            self.downloadedFiles = files.reduce(
                function (allFiles, file) {
                    if (file !== undefined && file['answer'] !== undefined) {
                        ...
                        //@todo need to get which Answer failed into the message
                        downloadErrors += '<br>A file failed to download, check the urls.';
                    }
                    return allFiles
                }, {}
            );
    ...
    applyAnswerKey() {
        ...
        for (const answerIndex in this.answers) { //answerIndex "answer1","answer2"
             ...
             */
            if (!this.answerGradingKey[answerIndex].mustAppear.every(function (param) {
                    if (!self.answers[answerIndex].includes(param)) {
                        self.wrong.push(`Answer ${answerNumber}: ` + self.guidance(self.answers[answerIndex], param))
                        return false;
                    }
    ...
    guidance(actual, expected) {
        ...
        switch (action) {
            ...
            case 'e_': // e_volume:-90
                if (expected.substring(expected.indexOf('e_volume')) != -1) {
                    return `The e_volume parameter isn't set properly.`;
                } else {
                    return `The ${this.actionDescriptions[action].title} parameter isn't quite right.`;
                }
            ...
            default:
                ...
                try {
                    ...
                    return `The ${action} parameter doesn't seem to belong here or isn't quite right.`;
                }
        }
    }
